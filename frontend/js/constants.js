const contractAddress = "0x4044b48ed66F47Cf7855a77C852B8CaeB20d7f72"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Mynies NFT Project!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Mynies is a comic-based NFT project, which are also will be the cutest collection in the blockchain. Are you ready? >.<" ';
...
const p_presale_coming_soon = "DM us at Twitter or Instagram to get on the Whitelist";
const p_presale_mint_not_whitelisted = "You are not whitelisted for the pre-sale.. Message us at Twitter or Instagram to get on the Whitelist!";
